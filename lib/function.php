<?php
defined('ROOT_PATH') or define('ROOT_PATH', rtrim(dirname(__FILE__), '/lib'));
date_default_timezone_set("PRC");
//全局错误码
defined('ERR_CODE_SUCCESS') or define('ERR_CODE_SUCCESS', 200);
defined('ERR_CODE_CUSTOMIZE') or define('ERR_CODE_CUSTOMIZE', 299);
...
spl_autoload_register(function ($class) {
    if (strpos($class, "app\\") === 0) {
        ...
        include ROOT_PATH . '/app/' . $class . '.php';
    } else if (strpos($class, "lib\\") === 0) {
        $class = str_replace("lib\\", '', $class);
        $class = str_replace("\\", '/', $class);
        include ROOT_PATH . '/lib/' . $class . '.php';
    }
});
